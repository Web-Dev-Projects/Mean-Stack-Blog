...
export class DataService {
    ...
    private setSidIn(headers) {
        return localStorage.getItem('sid') ? headers = Object.assign({}, headers, { sid: localStorage.getItem('sid') }) : headers;
    }

    getAll(urlExt: string = '', headers?) {
        headers = this.setSidIn(headers);
